  ...
  return (
    ...
    <div className="ml-64 min-h-screen">
      ...
      <section className="relative z-10 w-full min-h-screen flex flex-col items-center text-center px-6 pt-24">
        ...
        <p className="animate-fade-down text-sm font-medium text-gray-500 mb-4">
          SOFTWARE DEVELOPER
        </p>

        <h1 className="animate-fade-down text-5xl md:text-7xl font-bold tracking-tight">
          Hey, I'm Liam {" "}
          <span className = "inline-block animate-wave" style={{ animationDelay: "600ms" }}> 
            👋
          </span>
        </h1>

        <p className="animate-fade-down mt-5 text-lg md:text-xl text-gray-500 max-w-xl">
          I build software, solve problems, and occasionally
          spend far too long fixing one line of code.
        </p>

        <div className="animate-fade-down mt-10 w-full max-w-2xl" style={{ animationDelay: "300ms" }}>
          <div className="flex items-center bg-white border border-gray-200 rounded-2xl shadow-sm p-2">
            ...
            <button className="w-10 h-10 bg-[#0080FE] text-white rounded-full flex items-center justify-center hover:bg-[#0F52BA] transition">
              →
            </button>
